...
def build_sink_general_row() -> RowSpec:
    row_builder = row('Sink - General', default_height=8, default_span=12)
    ...
    output_row_batch_count.add_query(
        expr_histogram_quantile(
            0.999,
    ...
    row_builder.add_graph(output_row_batch_count)
    ...
    output_row_count_per_second.add_query(
        expr_sum_rate(
    ...
    row_builder.add_graph(output_row_count_per_second)
    ...
    row_builder.add_graph(sink_error_count_m)
